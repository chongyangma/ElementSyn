...
/* LS 2007: added CLAPACK calling convention */
...
#elif defined(TAUCS_BLAS_CBLASWRAP)
#include <blaswrap.h>
#define taucs_blas_name(x) (x##_)
#else
#error "taucs_blas_*_test: linking with the BLAS failed all attempts"
#endif

#if defined(OSTYPE_win32) || defined(OSTYPE_win64)
/* LS 2007: ssize_t must be signed */
#ifdef  _WIN64
...
#elif defined(OSTYPE_win32) || defined(OSTYPE_win64)
